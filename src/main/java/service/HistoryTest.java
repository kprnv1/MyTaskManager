...
//    private final TaskManager taskManager = Managers.getFileBackedTaskManager("data/task.csv");
//
//    public void start() {
...
//
//
//        TaskManager taskManagerReload = FileBackedTaskManager.loadFromFile("data/task.csv");
//
//        System.out.println("--->" + taskManagerReload.getHistory());
//
//        System.out.println("Задачи эквивалентны? " + isEqualsTasks(taskManager.getHistory(),
//                taskManagerReload.getHistory()));
//
//    }
